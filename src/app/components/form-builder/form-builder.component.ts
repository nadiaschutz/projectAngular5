...
export class FormBuilderComponent implements OnInit {
  ...
  saveQuestionnaire() {
    ...
    questionnaireIdentifier.value = this.questionnaireFormGroup.get('identifier').value;
    ...
    baseQuestionnaire.language = this.questionnaireFormGroup.get('language').value;
    this.questionnaireForDisplay = JSON.stringify(baseQuestionnaire);
